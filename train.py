...
if __name__ == '__main__':
    ...
    #training_data = process_data.load_processed_dataset(run_config['train_data_processed'],batch_size*50)
    validation_data = process_data.load_processed_dataset(run_config['validation_data_processed'],4000)
    ...
    for epoch in range(epoch_num):
        ...
        print("[{}] [epoch]:{} [avg_loss]:{:.3e} [TPR]:{:.4f} [auc_score]:{:.4f}".format(datetime.datetime.now(),epoch,avg_loss,validation_tpr,validation_auc_score))
